Shader "AlexMalyutinDev/Lit Reflection"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        // Renders by SpecularReflectivityPass
        Pass
        {
            Name "SpecularReflectivity"
            Tags
            {
                "LightMode" = "SpecularReflectivity"
            }
            ...
            // -------------------------------------
            // Shader Stages
            #pragma vertex SpecularReflectivityPassVertex
            #pragma fragment SpecularReflectivityPassFragment
            ...
            Varyings SpecularReflectivityPassVertex(Attributes input)
            {
